...
Es claro que en un número finito de pasos conseguiremos obtenemos el número de desanudamiento: Recorremos el nudo y al llegar a un cruce, si no hemos pasado anteriormente por él y es un undercrossing, lo convertimos en overcrossing. \\ 

Podemos ver el número de desanudamiento para el nudo trébol en la siguiente figura:\\
HACER LA IMAGEN!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
//HACER LAS 3 IMAGENESFIGURA 6.24
...
Al ir considerando los distintos nudos de la proyección, obtendremos dos nuevas proyecciones en cada paso. Con estas nuevas proyecciones podremos formar lo que se denomina \textbf{ árbol de resolución}. En la siguiente figura podemos ver el arbol de resolución del nudo trébol.\\

//HACER FIGURA DEL ARBOL DEL NUDO TRÉBOL!!!!!!!!!!!!!!!
...
El árbol de resolución del nudo trébol que vemos en la imagen //PONER ENLACE A LA FIGURA!!!!!!!!!!!! tiene una profundidad de 2 niveles (la proyección inicial no se cuenta como nivel). Es importante destacar que el único nudo que tiene profundidad de nudo igual a 0 es el nudo trivial. \\
...
Finalmente es necesario asignar los signos a cada uno de estos $2n$ números. Lo números pares que correspondan a un overcrossing tendrán signo negativo. Veamos un par de ejemplos:\\
//PONER LOS DOS EJEMPLOS (O UNO...SEGUN ME DE)
...
En este caso cada vez que pasamos por un cruce, tendremos un solo número asignado. De este modo la secuencia de números de la notación se compone de $2n$ elementos con valores desde 1 hasta n, cada uno de ellos repetido dos veces. El procedimiento es análogo que en la notación de Dowker. Veamos el mismo par de ejemplos.\\
//PODER LOS DOS EJEMPLOS 
...
En la siguiente figura vemos un enredo general y un ejemplo particular de un enredo.\\
//CREAR IMAGENes!!!!!!!!!!!!!!!!!!!!!!!!!!!

Pero la idea es trabajar con enredos más sencillos como son los que vemos en la figura //PONER ENLACE!. La notación se corresponde con el número de cruces que tiene el enredo con signo positivo y negativo según se ve en las imágenes.\\
//CREAR LAS 4 IMAGENES!!!!!!!!!!!!!!!!!!!!!!\\
...
A los enredos construidos con estas operaciones se les conoce con \textbf{enredos racionales}. Podemos ver un esquema básico estas dos operaciones en la siguiente imagen:\\
//HACER OPERACION DE SUMA Y MULTIPLICACIÓN!!!!!!!!!!!!!!!!!!!!!!\\
