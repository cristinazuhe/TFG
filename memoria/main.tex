...
A los enredos construidos con estas operaciones se les conoce con \textbf{enredos racionales}. Podemos ver un esquema básico estas dos operaciones en la imagen \ref{conw3}:\\
   \begin{figure}[h!]
   	\centering
   	\subfigure[Operacion suma]{\includegraphics[width=8.5cm]{ensum.png}}
   	\subfigure[Operacion multiplicacion]{\includegraphics[width=8.5cm]{enmul.png}}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=3.5cm]{en5fin.png}
...
\begin{figure}[h!]
	\centering
	\subfigure[Enlace -2 3 2]{\includegraphics[width=3.5cm]{en5fin.png}}
	\space
	\subfigure[Enlace 3 -2 3]{\includegraphics[width=3.5cm]{en6fin.png}}
