...
Consideremos la cadena $d$ de una trenza situada en el cubo $\mathds{D} = \{(x,y,z) / 0 \leq x,y,z \leq 1\}$. Sea AB un segmento de dicha cadena y C un punto en el cubo de forma que el triángulo $\triangle ABC$ no corta a ninguna otra cadena de la trenza y sólo toca a la cadena $d$ en el segmento AB. Supongamos además que los segmentos AC y CB cortar a cualquier plano horizontal del cubo en un sólo punto como mucho. Podemos visualizar estas condiciones en la primera imagen de la figura //PONER ENLACE!.\\
...
Podemos ver la representación de ambos movimientos en la figura //PONER ENLACE!.\\

//PONER FIGURA cadena d y ABC!!!!!!!!!!!!!!!!!!!!!!!! y operacion omega.\\


\textbf{\underline{Definición 2.1:}}\label{defequi}\\
Sean dos trenzas $\beta$, $\beta'$. Diremos que son \textbf{equivalentes} ($\beta \sim \beta'$) si existe una cadena finita de trenzas $ \beta = \beta_{0}$, $\beta_{1},...,\beta_{m}=\beta'$ tal que cada par de trenzas $ \beta_{i}, \beta_{i+1}, i=0,..,m-1, $ está relacionada por un movimiento elemental. A esta cadena de trenzas equivalentes le representaremos del siguiente modo:
\begin{center}
...
Hemos visto una definición que nos permite saber cuándo dos trenzas son equivalentes, pero es demasiado general como para poder llevarla a la práctica. En esta sección vamos a hacer un estudio más profundo de la teoría de trenzas para poder trabajar con ellas. Para ello tenemos que empezar viendo que el conjunto $\mathscr{B}_{n}$, dotado del producto de trenzas que veremos a continuación, tiene estructura de grupo no abeliano.\\

\textbf{\underline{Definición 2.2:}}\label{defpro}\\
Sean las trenzas $\beta$, $\beta' \in \mathscr{B}_{n}$. Definimos su \textbf{producto} $\beta \beta'$ como la n-trenza yuxtaposición que se crea al unir los extremos finales de las cuerdas de $\beta$ con los extremos iniciales de las cuerdas de $\beta'$.\\

En la figura //PONER ENLACE!!!! se puede ver un ejemplo del producto de dos trenzas.\\
//CREAR FIGURAS DEL PRODUCTO DE DOS TRENZAS!!!!!!!!!!!!!!!!!\\
...
\begin{pro} Producto de trenzas \textbf{asociativo}.\\
	Sean las trenzas $\beta1$, $\beta2$, $\beta3 \in \mathscr{B}_{n}$. Se verifica:
	\begin{center}
		 $(\beta1 \beta2) \beta3 \sim \beta1 (\beta2 \beta3)$.
\end{center}
	\begin{proof}	
...
\begin{pro} Producto de trenzas \textbf{no conmutativo}.\\
	...
	\end{proof}
\end{pro}
Podemos ver un ejemplo de dos trenzas no conmutativas en la figura //PONER ENLACE!!!\\
//PONER EJEMPLO DE DOS TRENZAS NO CONMUTATIVAS!!!!!!!!!!!!!!!\\

\begin{pro}  \textbf{Elemento neutro}.\\
...
\begin{pro}  \textbf{Elemento inverso}.\\
	Sea la trenza $\beta \in \mathscr{B}_{n}$. Entonces existirá una trenza $\beta^{-1} \in \mathscr{B}_{n}$ verificando:
	\begin{center}
	...
	\begin{proof} 
		Sea la trenza $\beta$ a la que notamos como $\beta = \pm \sigma1 \pm \sigma2 ... \pm \sigma_{m}$.\\

		 Construimos la trenza $\beta'$ a la que notamos como $\beta' = \mp \sigma_{m} ...\mp \sigma2 \mp \sigma1$. Veamos que esta trenza es la trenza inversa:\\
\begin{center}
			 $\beta \beta'$ = $\pm \sigma1 \pm \sigma2 ... \pm \sigma_{m} \mp \sigma_{m} ...\mp \sigma2 \mp \sigma1$ = $\pm \sigma1 \pm \sigma2 ... \pm \sigma_{m-1} \mp \sigma_{m-1} ...\mp \sigma2 \mp \sigma1$ = $ 1_{n} $.\\
\end{center}		 
\begin{center}
			 $ 1_{n} $ = $\mp \sigma_{m} ...\mp \sigma2 \mp \sigma1 \pm \sigma1 \pm \sigma2 ... \pm \sigma_{m}$ = $\mp \sigma_{m} ...\mp \sigma2 \pm \sigma2 ... \pm \sigma_{m} = \beta' \beta$.\\
\end{center}
...
\begin{enumerate}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width=10cm]{itrenzas/M1.png}
		\caption{Primer movimiento.}
		\label{tren6} 
	\end{figure}
	
	\item \underline{Segundo movimiento - M2:} \\
	Las palabras $+\sigma(i) +\sigma(i+1) +\sigma(i)$ y $+\sigma(i+1) +\sigma(i) +\sigma(i+1)$ son equivalentes. Se puede ver en la figura \ref{tren7}.
	\begin{figure}[h!]
		\centering
		\includegraphics[width=16cm]{itrenzas/M2.png}
	...
	Las palabras $+\sigma(i) +\sigma(j)$ y $+\sigma(j) +\sigma(i)$ son equivalentes si se verifica que $|i-j| > 1$. Se ve claro en la figura \ref{tren8}.
	\begin{figure}[h!]
		\centering
...
\end{enumerate}
En la figura \ref{tren9} podemos ver los movimientos que nos demuestran que dos trenzas dadas más complejas son equivalentes. Aplicamos M3 y posteriormente M2.\\
\begin{figure}[h!]
	\centering
...
\begin{enumerate}
	...
	Las palabras $\beta$ y $+\sigma(i) \beta -\sigma(i)$ generan trenzas cerradas equivalentes. Se puede ver en la figura \ref{tren11}.
	\begin{figure}[h!]
		\centering
