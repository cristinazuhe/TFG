...
Hemos visto una definición que nos permite saber cuándo dos trenzas son equivalentes, pero es demasiado general como para poder llevarla a la práctica. En esta sección vamos a hacer un estudio más profundo de la teoría de trenzas para poder trabajar con ellas. Para ello tenemos que empezar viendo que el conjunto ${B}_{n}$, dotado del producto de trenzas que veremos a continuación, tiene estructura de grupo no abeliano.
...
En la figura \ref{grupo0} se puede ver un ejemplo del producto de dos trenzas: la trenza (c) es el producto de las trenzas (a) y (b).\\
   \begin{figure}[h!]
   	\centering
   	\subfigure[$-\sigma3+\sigma1$]{\includegraphics[width=5cm]{itrenzas/1c1.png}}
   	\subfigure[$+\sigma2+\sigma3$]{\includegraphics[width=5cm]{itrenzas/1c2.png}}
   	\space
   	\subfigure[$-\sigma3+\sigma1+\sigma2+\sigma3$]{\includegraphics[width=4cm]{itrenzas/1c3.png}}  	
   	\caption{}
   	\label{grupo0} 
   \end{figure}
...
Veamos el ejemplo de la figura \ref{grupo1}: Las trenzas (a) y (b) son equivalentes luego la parte superior de las trenzas (e) y (f) es equivalente. Las trenzas (c) y (d) son equivalentes, luego la parte inferior de las trenzas (e) y (f) es equivalente. La unión de estas dos partes que mencionamos en las trenzas (e) y (f) no supone la pérdida de equivalencia. \\
   \begin{figure}[h!]
	...
	\subfigure[$-\sigma3-\sigma2-\sigma3-\sigma3+\sigma1-\sigma3$]{\includegraphics[width=3.6cm]{itrenzas/3c5.png}}
	\includegraphics[width=1.5cm]{itrenzas/flechac.png}
	\subfigure[$-\sigma2-\sigma3-\sigma2+\sigma1-\sigma3-\sigma3$]{\includegraphics[width=3cm]{itrenzas/3c6.png}}   	
   	\caption{}
   	\label{grupo1} 
   \end{figure}
...
En la figura \ref{grupo2} podemos ver que, efectivamente, el producto de las trenzas $\beta1, \beta2 y \beta3$ es asociativo: las trenzas (e) y (g) son iguales.\\
   \begin{figure}[h!]
   	\centering
	\subfigure[$\beta1 = -\sigma3+\sigma1$]{\includegraphics[width=5cm]{itrenzas/1c1.png}}
	\subfigure[$\beta2 = +\sigma2+\sigma3$]{\includegraphics[width=5cm]{itrenzas/1c2.png}}  
	\subfigure[$\beta3 = +\sigma3$]{\includegraphics[width=3.2cm]{itrenzas/2c1.png}}  	
	
	\subfigure[$\beta1\beta2$]{\includegraphics[width=4.8cm]{itrenzas/1c3.png}}  	
	\subfigure[$(\beta1\beta2)\beta3$]{\includegraphics[width=4cm]{itrenzas/2c2.png}} 
	
	\subfigure[$\beta2\beta3$]{\includegraphics[width=5.5cm]{itrenzas/2c3.png}}  	
	\subfigure[$\beta1(\beta2\beta3$)]{\includegraphics[width=4cm]{itrenzas/2c2.png}} 
   	\caption{}
   	\label{grupo2} 
   \end{figure}
...
En la figura //PONER ENLACE!!!! podemos ver un ejemplo de una trenza y su trenza inversa.\\
//CREAR IMAGEN DE UNA TRENZA Y SU INVERSA. CREAR IMAGEN DE LA TRENZA TRIVIAL CORRESPONDIENTE. \\
...
\bigskip
	...
	\begin{enumerate}
		...
		\item $ \sigma(i+1)-\sigma(i)-\sigma(i+1) =-\sigma(i)-\sigma(i+1)\sigma(i) $ siendo $i=2,..,n-2 $
	\end{enumerate}
	En la figura //PONER ENLACE!!! podemos ver que efectivamente son equivalencias ciertas.\\
	//PONER LAS 4 TRENZAS EQUIVALENTES QUE SE VEA BIEN LA EQUIVALENCIA!!!!!!!!!!!!! \\
