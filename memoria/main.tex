...
\textbf{\underline{Definición:}}\\
Sean dos trenzas $\beta$, $\beta'$. Diremos que son \textbf{equivalentes} ($\beta \sim \beta'$) si existe una cadena finita de trenzas $ \beta = \beta_{0}$, $\beta_{1},...,\beta_{m}=\beta'$ tal que cada par de trenzas $ \beta_{i}, \beta_{i+1}, i=0,..,m-1, $ está relacionada por un movimiento elemental. \\
...
Hemos visto una definición que nos permite saber cuándo dos trenzas son equivalentes, pero a la hora de la práctica esta definición no nos aporta 
