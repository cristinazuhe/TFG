...
Podemos ver algunos ejemplos de trenzas en la figura \ref{tren1}.\\
   \begin{figure}[h!]
   	\centering
   	\subfigure[$+\sigma2-\sigma1+\sigma2-\sigma1-\sigma3$]{\includegraphics[width=3.6cm]{itrenzas/t1.png}}
   	\space
   	\subfigure[$-\sigma1+\sigma2-\sigma1+\sigma2$]{\includegraphics[width=3.5cm]{itrenzas/t2.png}}
...
Al igual que hacíamos con los nudos, podremos representar una trenza en el plano visualizando su proyección. En la figura \ref{tren2} se pueden ver las proyección de las trenzas representadas en la figura \ref{tren1}.\\
   \begin{figure}[h!]
   	\centering
   	\subfigure[$+\sigma2-\sigma1+\sigma2-\sigma1-\sigma3$]{\includegraphics[width=3.3cm]{itrenzas/t1pro.png}}
   	\space
   	\subfigure[$-\sigma1+\sigma2-\sigma1+\sigma2$]{\includegraphics[width=2.8cm]{itrenzas/t2pro.png}}
...
Intuitivamente diremos que dos trenzas son equivalentes si podemos deformar las cadenas de las trenzas de forma que ambas trenzas se vean iguales. Las trenzas de la figura \ref{tren3} son equivalentes.\\
   \begin{figure}[h!]
   	\centering
   	\subfigure[$+\sigma1-\sigma2+\sigma2$]{\includegraphics[width=3.5cm]{itrenzas/t3.png}}
   	\space
   	\subfigure[$+\sigma1+\sigma2-\sigma2$]{\includegraphics[width=3.5cm]{itrenzas/t4.png}}
...
\end{center}
Para poder trabajar de forma cómodo con las trenzas vamos a darle la siguiente notación:\\
...
Podemos verlo más claro en la figura \ref{tren4}.\\
   \begin{figure}[h!]
   	\centering
   	\subfigure[$+\sigma(i)$]{\includegraphics[width=3.1cm]{itrenzas/t5.png}}
   	\space
   	\subfigure[$+\sigma(i)$]{\includegraphics[width=3cm]{itrenzas/t6.png}}
   	\caption{Signo cruce.}
   	\label{tren4} 
   \end{figure}
...
Cualquier trenza no trivial tendrá de una serie de cruces. En cada plano horizontal podremos tener como mucho un cruce. Notaremos a la trenza con la secuencia de cruces que tenga, empezando por la parte superior de la trenza. A esta secuencia se le conoce como \textbf{palabra} que representa a la trenza. Podemos ver un ejemplo en la figura \ref{tren5}.\\
   \begin{figure}[h!]
   	\centering
   	\includegraphics[width=8cm]{itrenzas/t7.png}
...
\end{center}
Para analizar cuándo dos trenzas son equivalentes tendremos que ver cuándo las palabras que representan a dichas trenzas son equivalentes. Dos palabras representarán la misma trenza si y sólo si podemos pasar de una palabra a otra por un secuencia de estas tres operaciones:
\begin{enumerate}
	\item \underline{Primer movimiento - M1:} \\
	Podemos añadir o eliminar $+\sigma(i) -\sigma(i)$ o $-\sigma(i) +\sigma(i)$ en cualquier palabra. Es claro que la palabra inicial y la palabra final representan a la misma trenza. Podemos verlo en la figura //PONER ENLACE!!\\
	//PONER FIGURA DEL PRIMER MOVIMIENTO!!!!!!!!CAPTURA A INICIO Y A FIN.
	
	\item \underline{Segundo movimiento - M2:} \\
	Las palabras $+\sigma(i) +\sigma(i+1) +\sigma(i)$ y $+\sigma(i+1) +\sigma(i) +\sigma(i+1)$ son equivalentes. Se puede ver en la figura //PONER ENLACE!!\\
	//PONER FIGURA DEL SEGUNDO MOVIMIENTO!!!!!!!
	
	
	\item \underline{Tercer movimiento - M3:} \\
	Las palabras $+\sigma(i) +\sigma(j)$ y $+\sigma(j) +\sigma(i)$ son equivalentes si se verifica que $|i-j| > 1$. Se ve claro en la figura //PONER ENLACE!!\\
	//PONER FIGURA DEL TERCER MOVIMIENTO!!!!!
	
\end{enumerate}
En la figura //PONER REFERENCIA!!! podemos ver los movimientos que nos demuestran que las trenzas vistas en la figura //PONER REFERENCIA !!!! son equivalentes.\\
//PONER PASO A PASO LA EQUIVALENCIA DE LAS TRENZAS QUE HE PUESTO ANTES QUE SON EQUIVALENTES.\\

\begin{center}
	\subsubsection{Trenzas Markov-equivalentes:}
\end{center}
Es claro que si tenemos dos trenzas que son equivalentes, sus trenzas cerradas nos darán nudos que serán equivalentes. Pero...¿puede darse el caso de tener dos trenzas no sean equivalentes y que sus trenzas cerradas sí lo sean?Veamos, mediante el ejemplo de la figura //PONER ENLACE, que sí es posible:\\
//CREAR TRENZAS NO EQUIVALENTES PERO QUE AL CERRAR SI LO SEAN!!!!!!!!\\
...
\begin{teo} \textbf{Teorema de Markov.} \\
...
\begin{enumerate}
	...
	Las palabras $\beta$ y $+\sigma(i) \beta -\sigma(i)$ son equivalentes.Se puede ver en la figura //PONER ENLACE!!\\
	//PONER FIGURA DEL PRIMER MOVIMIENTO!!!!!!!
	
	\item \underline{Estabilización - Mv2:} \\
	Esta operación nos permite modificar el número de cadenas de las trenzas. 
	Sea la palabra $\beta$ de n cadenas. Esta palabra es equivalente a $\beta \sigma(n)$ o bien $\sigma(n) \beta $. Se puede ver en la figura //PONER ENLACE!!\\
	//PONER FIGURA DEL SEGUNDO MOVIMIENTO!!!!!!! 
	
\end{enumerate}
	Podemos ver un ejemplo de dos trenzas Markov-equivalentes en la figura //PONER ENLACE!!!\\
	//CREAR IMAGENES FINALES DE MI RESUMEN 
